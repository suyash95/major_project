...
The `home-routes` handler in the `web.routes.home` namespace
...
The `home-page` function will in turn call the `web.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/web/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `web.handler` namespace:
...
Middleware used for development is placed in the `web.dev-middleware` namespace found in
